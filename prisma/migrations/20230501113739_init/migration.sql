-- CreateEnum
CREATE TYPE "SpecialityEnum" AS ENUM ('RESEARCH_ASSISTANT', 'BIO_MEDICAL_ENGINEER', 'HIP', 'KNEE', 'SHOULDER', 'ELBOW', 'FOOT_AND_ANKLE', 'WRIST', 'FINGER_JOINTS', 'UPPER_LIMB', 'LOWER_LIMB');
